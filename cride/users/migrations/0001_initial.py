# Generated by Django 2.1.5 on 2019-02-01 12:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in the format: +99999999. Up to 15 digits alloweb.', regex='\\+?1?\\d{9,15}$')])),
                ('is_client', models.BooleanField(default=True, help_text=('Help easily distinguish users and perfrom queries. ', 'Clients are the main type of user.'), verbose_name='client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biography', models.TextField(blank=500, max_length=500)),
